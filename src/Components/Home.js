    ...
    return(
        <div className="Home">
            <div className="Home--text">
                ...
                <p className="Home--text-about">I'm currently pursuing Electronics and Communication Engineering from Sri Venkateswara College of Engineering in Tirupati.</p>
            </div>
